              ...
              {filtered.map((f: any) => {
                ...
                return (
                  <tr key={f.id}>
                    ...
                    <td className="text-xs text-muted-foreground">{new Date(f.created_at).toLocaleDateString("en-GB").replace(/\//g, "-")}</td>
                    <td className="text-xs text-muted-foreground">
                      {f.signed_at ? new Date(f.signed_at).toLocaleDateString("en-GB").replace(/\//g, "-") : "—"}
                    </td>
                    <td>
