...
const mainNav: NavItem[] = [
  ...
  { label: "קריאות שירות", icon: Shield, path: "/it-tickets", roles: ["admin", "it_manager", "super_admin", "operations", "direct_manager", "payroll", "hr", "finance", "legal", "secretariat", "ceo"], preload: preload.itTickets },
