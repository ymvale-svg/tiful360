...
BEGIN
  ...
  -- Find a matching active employee that was pre-provisioned by an admin
  ...
  -- Re-point the linked user id to this auth user (handles re-invites / Google first login after invite)
